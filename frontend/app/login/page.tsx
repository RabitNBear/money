          ...
          <div className="mt-[30px] pt-5 border-t border-gray-100 text-center">
            ...
            <div className="flex justify-center gap-[15px]">
              ...
              <button
                ...
                className="w-[60px] h-[60px] rounded-full bg-[#FEE500] text-[#3c1e1e] font-bold transition-transform hover:scale-105 active:scale-95 cursor-pointer"
              >
                K
              </button>
              ...
              <button
                ...
                className="w-[60px] h-[60px] rounded-full bg-[#ea4335] text-white font-bold transition-transform hover:scale-105 active:scale-95 cursor-pointer"
              >
                G
              </button>
            </div>
